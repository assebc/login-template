<?php
    ...
    if(isset($_POST['but_login'])){
        ...
        $result = mysqli_query($conexao, "IF EXISTS(SELECT * FROM users WHERE user == $user OR email == $user AND password == $password)");
    }
        ...
        <div class="main_login">
            ...
            <div class="right_login">
                <div class="card_login">
                    ...
                    <a class="a_nodef" href="#"><button class="but_login" name="but_login" onclick="checkLogin();">Login</button></a>
                </div>
            </div>
        </div>
    </body>
